...
public class ChuyenKhoExcelExporter {
    ...
    public static class LoRow {
        ...
        public LoRow(String tenThuoc, String soLo, int soLuongTon) {
    ...
    public static void xuatFileMau(String nguoiVanChuyen, String khoXuat, String khoNhan,
                                    List<LoRow> dsLo, File file) throws Exception {
        try (OutputStream os = Files.newOutputStream(file.toPath());
            ...
            write(zos, "xl/worksheets/sheet1.xml",      sheet(nguoiVanChuyen, khoXuat, khoNhan, dsLo));
        }
    }
    ...
    private static String sheet(String nguoiVC, String khoXuat, String khoNhan, List<LoRow> dsLo) {
        ...
        sb.append(colDef(3, 3, 15)); // C: SL Tồn
        sb.append("</cols>\n");
        sb.append("<sheetData>\n");
        ...
        // Row 1: Title
        merges.add("A1:C1");
        sb.append(row(r++, new CV[]{ new CV("PHIẾU CHUYỂN KHO NỘI BỘ - NHÀ THUỐC LONG NGUYÊN", 0) }));

        // Row 2: Instructions
        merges.add("A2:C2");
        sb.append(row(r++, new CV[]{ new CV(
            "Mẫu đã điền sẵn thuốc tồn kho xuất. Xóa dòng không muốn chuyển rồi nhập lại vào hệ thống.", 1) }));

        // Row 3: Người vận chuyển
        merges.add("B3:C3");
        sb.append(row(r++, new CV[]{
            new CV("Người Vận Chuyển:", 3),
            new CV(nguoiVC != null ? nguoiVC : "", 4)
        }));
    ...
    private static String workbook() {
        return "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?>" +
            ...
            "<sheets><sheet name=\"ChuyenKho\" sheetId=\"1\" r:id=\"rId1\"/></sheets>" +
            "</workbook>";
    }
